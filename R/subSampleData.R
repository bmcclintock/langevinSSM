...
#' @param col_to_na A character vector of column names in the data frame for which to introduce missing values. Default is \code{c("x", "y", "smaj", "smin", "eor", "x.err", "y.err")}. Ignored unless \code{propMissing > 0}.
...
#' @export
subSampleData <- function(data, samplingRate = 1, propMissing = 0, col_to_na = c("x", "y", "smaj", "smin", "eor", "x.err", "y.err")){
