...
tau <- c(1.2,0.8) # x- and y-axis error scaling parameter
rho_o <- 0.5 # error correlation
...
save(parMat,beta,sigma,gamma,obsPerAnimal,subDat,langFit,tau,rho_o,timeStep,samplingRate,propMissing,measurementError,sca,npoints,curweight,covRange,map,useInitialValues,covTimes,file=paste0("simulation/results/",dataName,"_tau",paste0(tau,collapse = "_"),"_rho_o",rho_o,"_samplingRate",samplingRate,"_propMissing",propMissing,"_aniMotum",use_aniMotum,"_npoints",npoints,"_curweight",curweight,"_zetaScale",zetaScale,".RData"))
